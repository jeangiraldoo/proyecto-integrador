...
Este flujo documenta la Heurística de Prevención de Errores: cómo el frontend evalúa y advierte al usuario si su reprogramación generará un conflicto de carga *antes* de enviar la petición al backend.
